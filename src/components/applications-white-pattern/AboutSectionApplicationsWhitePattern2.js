...
export default function AboutSectionApplicationsWhitePattern2() {
    return (
        <React.Fragment>
            <>
                <section className="relative py-24 bg-white overflow-hidden" style={{backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center'}}>
  <div className="container px-4 mx-auto mb-16 md:mb-0">
    <div className="md:w-1/2 pl-4">
      ...
      <h3 className="mb-6 text-4xl md:text-5xl leading-tight text-coolGray-900 font-bold tracking-tighter">Great work starts with your app</h3>
      <p className="mb-12 text-lg md:text-xl text-coolGray-500 font-medium">With our integrated CRM, project management, collaboration and invoicing capabilities, you can manage every aspect of your business in one secure platform.</p>
      <div className="flex flex-wrap mb-10 text-center md:text-left">
        ...
        <div className="w-full md:flex-1 md:pt-3">
          <div className="md:max-w-sm">
            <h3 className="mb-4 text-xl md:text-2xl leading-tight text-coolGray-900 font-bold">Measure your performance</h3>
      ...
      <div className="flex flex-wrap mb-10 text-center md:text-left">
        ...
        <div className="w-full md:flex-1 md:pt-3">
          <div className="md:max-w-sm">
            <h3 className="mb-4 text-xl md:text-2xl leading-tight text-coolGray-900 font-bold">Build your website</h3>
      ...
      <div className="flex flex-wrap text-center md:text-left">
        ...
        <div className="w-full md:flex-1 md:pt-3">
          <div className="md:max-w-sm">
            <h3 className="mb-4 text-xl md:text-2xl leading-tight text-coolGray-900 font-bold">Connect multiple apps</h3>
  ...
  <div className="md:absolute md:top-28 lg:top-1/2 md:-right-96 xl:-right-80 md:-mr-56 lg:-mr-20 xl:-mr-0 md:transform lg:-translate-y-1/2 px-4 mb-16 md:mb-0">
    <div className="relative max-w-max">
      ...
      <img className="absolute -top-24 right-0 md:mt-px md:right-96 md:mr-52 lg:mr-16 xl:-mr-20 w-28 md:w-auto text-blue-500" src="flex-ui-assets/elements/dots2-blue.svg" />
      <img className="absolute -bottom-24 left-0 md:left-auto md:mt-px md:right-96 md:mr-52 lg:mr-16 xl:-mr-20 w-28 md:w-auto text-red-500" src="flex-ui-assets/elements/dots2-red.svg" />
      <img className="absolute left-0 top-1/2 transform -translate-y-1/2 w-28 md:w-auto text-yellow-400" src="flex-ui-assets/elements/circle2-yellow.svg" />
    </div>
  </div>
</section>
