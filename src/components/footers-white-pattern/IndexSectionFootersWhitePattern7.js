...
export default function IndexSectionFootersWhitePattern7() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap lg:items-center pt-24 pb-12 -mx-4">
      <div className="w-full md:w-3/4 px-4">
        ...
        <p className="mb-12 text-base md:text-lg text-coolGray-400 font-medium md:max-w-sm">Create your own Software As A Service Application with Artemis Solutions.</p>
        <div className="mb-12 md:mb-0 flex flex-wrap -mx-3 md:-mx-6">
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Services</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Characteristics</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Cost</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Support</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Jobs</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Support</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Confidentiality</a></div>
        </div>
      </div>
  ...
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap items-center py-12 md:pb-32">
      <div className="w-full md:w-1/2 mb-6 md:mb-0">
        <p className="text-coolGray-400 font-medium">© 2021 Artemis. All rights reserved.</p>
      </div>
