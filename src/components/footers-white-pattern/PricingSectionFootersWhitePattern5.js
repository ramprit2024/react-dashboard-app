...
export default function PricingSectionFootersWhitePattern5() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap lg:items-center pt-24 pb-12 -mx-4">
      <div className="w-full md:w-3/4 px-4">
        ...
        <p className="mb-12 text-base md:text-lg text-coolGray-400 font-medium md:max-w-sm">Launch your own Software As A Service Application with Flex Solutions.</p>
        <div className="mb-12 md:mb-0 flex flex-wrap -mx-3 md:-mx-6">
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Product</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Features</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Pricing</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Resources</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Careers</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Help</a></div>
          <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Privacy</a></div>
        </div>
      </div>
